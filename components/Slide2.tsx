export const Slide2: React.FC = () => {
  return (
    <div className="relative flex h-screen w-screen flex-col justify-between overflow-x-hidden bg-blue text-white lg:flex-row lg:items-center xl:px-24">
      <div className="flex flex-col gap-4 p-8 md:gap-12 md:p-24 md:py-4 lg:w-2/4 ">
        <div className="">
          <img src="icon-phone.svg" className="w-xs" />
        </div>
        ...
        <div>
          <button className="rounded-sm bg-green py-2 px-3">
            Pobierz aplikację
          </button>
        </div>
      </div>
